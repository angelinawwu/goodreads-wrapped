        ...
        {books && books.length > 0 ? (
          ...
          >
            {books.map((book: any, index: number) => (
              <div key={index} className="flex justify-center transition-transform duration-200 hover:scale-105">
          ...
          <p className="text-[1.2rem] opacity-70 my-8 font-[var(--font-main)] text-black">No books found for 2025</p>
        )}
      </div>
